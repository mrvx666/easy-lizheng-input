...
SW_header = (1, 1)
QY = "取样编号、取样深度、取样长度、取样类型(0-原状土样，1-扰动土样，3-岩样，4-水样）、质量密度、土粒比重、含水量、液限、塑限、最小密度、最大密度、水上休止角、水下休止角、渗透系数、水平渗透系数、垂直渗透系数、单轴抗压强度、自然抗压强度、饱和抗压强度、抗拉强度、抗剪强度、软化系数、桩侧摩阻力、桩端摩阻力、十字板剪切强度、无侧限抗压强度（原状）、无侧限抗压强度（重塑）、灵敏度、透水率、剪切波速、纵波波速、动弹性模量、动剪切模量、动泊松比、回弹模量"
QY_header = (1, 1)
