...
ZK_header = (1, 0)
TC = "岩土名称、层底深度、地层厚度、主层编号、亚层编号、次亚层编号、地质时代、地质成因、颜色、密实度、湿度、可塑性、浑圆度、均匀性、风化程度、" \
...
SW_header = (1, 1)
QY = "取样编号、取样深度、取样长度、取样类型(0-原状土样，1-扰动土样，3-岩样，4-水样）、质量密度、土粒比重、含水量、液限、塑限、" \
